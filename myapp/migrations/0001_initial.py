# Generated by Django 3.1.5 on 2021-01-20 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=100, null=None)),
                ('address', models.CharField(max_length=255, null=None, unique=True)),
                ('Faculty', models.CharField(choices=[('manager', 'Quản Lý'), ('staff', 'Tư Vấn')], default='Tư Vấn', max_length=20, null=None)),
            ],
        ),
        migrations.CreateModel(
            name='Product_List',
